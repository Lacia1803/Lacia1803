...
<a href="https://github.com/Lacia1803?tab=followers">
  <img src="https://img.shields.io/github/followers/Lacia1803?label=Followers&style=for-the-badge&color=8B5CF6&labelColor=1F2937&logo=github" alt="Followers" />
</a>
<img src="https://komarev.com/ghpvc/?username=Lacia1803&label=Profile+Views&color=06B6D4&style=for-the-badge" alt="Profile views" />
<a href="mailto:phungvoquochien.dev@gmail.com">
  <img src="https://img.shields.io/badge/Open%20to%20Work-Yes-22C55E?style=for-the-badge&labelColor=1F2937&logo=checkmarx&logoColor=white" alt="Open to work" />
</a>
...
const lacia = {
  ...
  school: "Dalat University — class CTK46-PM",
  internship: "IT Center @ DLU · building an IT Helpdesk system",
  focus: ["Next.js", "Node.js", "PostgreSQL", "Docker"],
  goal: "Fullstack Developer, shipping things that people actually use",
  motto: "The curtain falls, but the dream goes on.",
};
```

- 🎓 &nbsp;Final-year **Software Engineering** student @ **Dalat University**
- 💼 &nbsp;Interning at the university's **IT Center** — building **DLU OneDesk**, an IT Helpdesk & lab-equipment system
- 🌱 &nbsp;Going deeper on **Next.js · Node.js · PostgreSQL · Docker**
- 🎯 &nbsp;Actively looking for a **Fullstack Developer** role after graduation
- ⚡ &nbsp;I like clean architecture, dark-mode UIs, and code that's readable six months later
...
|:--|:--|:--|
| 🖥️ **[DLU OneDesk](https://github.com/Lacia1803/dlu-onedesk)** | IT Helpdesk & lab-equipment management system — my graduation internship project at DLU | `Next.js 16` `Prisma` `PostgreSQL` `NextAuth (2FA)` `Gemini API` `Docker` |
| 🏋️ **[FitTrack](https://github.com/Lacia1803/fittrack)** | Workout & nutrition tracking app, installable as a PWA | `Next.js 15` `Supabase` `Docker` |
| 📚 **[DoAnWebNangCao](https://github.com/Lacia1803/DoAnWebNangCao)** | Library management system — full-stack CRUD with auth & role management | `Node.js` `Express` `React` `PostgreSQL` `Docker` |
| 📖 **[Ebook2LaTeX](https://github.com/Lacia1803/Ebook2LaTeX)** | Tool that converts ebooks into clean LaTeX documents | `Python` |
...
<picture>
  ...
  <img height="165" src="https://github-readme-streak-stats.herokuapp.com/?user=Lacia1803&theme=default&hide_border=true&background=00000000&fire=8B5CF6&ring=06B6D4" alt="GitHub streak" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Lacia1803/Lacia1803/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Lacia1803/Lacia1803/output/github-contribution-grid-snake.svg" />
  <img width="100%" src="https://raw.githubusercontent.com/Lacia1803/Lacia1803/output/github-contribution-grid-snake.svg" alt="Contribution snake" />
</picture>
...
<i>“The curtain falls, but the dream goes on.”</i>
